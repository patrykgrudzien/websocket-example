...
public class WebSocketConfig implements WebSocketMessageBrokerConfigurer {
     ...
     * The endpoint "/chat" will allow us to connect to "ws://localhost:8080/chat" with the default Spring
     * port configuration. SockJS fallback protocol allows a client that doesn't support WebSocket natively
     * to create a mimic WebSocket over a HTTP connection.
